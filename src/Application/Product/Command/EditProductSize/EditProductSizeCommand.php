...
final readonly class EditProductSizeCommand
{
    public function __construct(public string $productId, public string $productSizeId, public int $height, public int $width, public ?int $thickness)
    {
    }
