...
final class Version20260107105142 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_size (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, height INT NOT NULL, width INT NOT NULL, thickness INT DEFAULT NULL, product_id INT NOT NULL, PRIMARY KEY (id))');
